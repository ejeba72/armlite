...
// upper index = arrayLength - 1 i.e. nth element has an index of n-1
  ...
  b search
lowerRange:
  mov r4, r3  // new upper index
  b search
upperRange:
  mov r2, r3  // new lower index
search:
  sub r7, r4, r2  // index difference
  lsr r3, r7, #1  // relative middle index = index difference / 2
  add r11, r2, r3  // absolute middle index = lower index + relative middle index
  lsl r10, r11, #2  // accounting for each block of memory (4 bytes per block)
